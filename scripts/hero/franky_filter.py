...
def franky(src, out, pitch=PITCH, palette="coral", amp=AMP, ss=SS,
    ...
    im.save(out, quality=quality) if str(out).endswith(".webp") else im.save(out)
    return out
